...
with col1:
    ...
    st.image(r"images/iec_3d.PNG", use_container_width=True)
    st.markdown("Complex Terrain Analysis for IEC Norm")

with col2:
    st.subheader("Vector analysis and statistics")
    st.image(r"images/lcoe_bl_2.png", use_container_width=True)
...
with col1:
    ...
    st.image(r"images/big data.png", use_container_width=True)
